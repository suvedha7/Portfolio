...
<div class="container">
    <div class="abt">
        <div class="row justify-content-between">
            <div class="col text">
                <center><h1> <b>I'm Suvedha Pillai</b></h1><h3>I am a passionate <b>computer science student</b> currently pursuing bachelor's degree from Thakur College.</h3>
                <h5>I have a keen interest in problem-solving and enjoy diving into new technologies.<br>
                I particularly love working on languages and crafting user interfaces.<br>
                Lately, I've been focusing more on backend development for websites.<br>
                Apart from my technical pursuits, I'm a <b>sketcher and drawing enthusiast</b>.</h5></center>
            </div>
            <div class="col img">
                <center><img src="about.jpg" height=300 width=300 alt=""></center>
            </div>
        </div>
    </div>
</div>
